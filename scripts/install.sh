...
log ""
log "Next steps:"
log "  sudo ${TARGET}/scripts/doctor lab1        # Check prerequisites"
log "  sudo ${TARGET}/scripts/lab.sh lab1 plan   # Preview what will happen"
log "  sudo ${TARGET}/scripts/lab.sh lab1 all    # Full setup"
